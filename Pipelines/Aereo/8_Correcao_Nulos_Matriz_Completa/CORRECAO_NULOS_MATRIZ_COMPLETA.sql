...
create materialized view matriz_cargas_codemge.mvw_matriz_2019_completa_ratio_uf_macroproduto as 
with matriz_completa_pnl as (
    ...
    GROUP BY mcp.utp_o, mcp.utp_d, mcp.uf_o, mcp.uf_d, mcp.id_macroproduto_peltmg
), ratio_ton as (
    select 
        mc.utp_o,
        mc.utp_d,
    ...
    left join agrupamento_mc azp on 
        ...
        azp.uf_o = mc.uf_o and 
        azp.uf_d = mc.uf_d and 
...
select 
    ...
    val_ratio
from ratio_ton
order by uf_o, uf_d, id_macroproduto_peltmg;